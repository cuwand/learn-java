...
public class SharedFiFoQueue {
	...
	public void add(Object elem) throws InterruptedException {
		...
		while (current >= elems.length) {
			System.out.println("Producer Wait to Add Object");
			isFull.await();
		}

		System.out.println("Placing Item >> " + elem);
	...
	public Object remove() throws InterruptedException {
		...
		System.out.println("Notify the producer that there is space available.");
		isFull.signal();
