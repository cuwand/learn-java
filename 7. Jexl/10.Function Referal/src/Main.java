...
public class Main {
	...
	public static final String ReferalFunction = "$$ var refSt = st;\n";

	// call from DB or ETC
	public static String generateFunctions() {
		return SalaryThresholdFunctions + PercentageFunctions + ReferalFunction;
	}

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		String salaryCondition = "loan > pt(refSt(salary, threshold))";
